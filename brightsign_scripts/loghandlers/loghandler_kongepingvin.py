...
def main(log_destination_root_folder):
    ...
    sw1='LS=EIEM_Kongepingvin_18.05_DA_P'
    sw2='LS=EIEM_Kongepingvin_18.05_DA_S1'
    sw3='LS=EIEM_Kongepingvin_18.05_DA_S2'
    sw4='LS=EIEM_Kongepingvin_18.05_DA_S3'
    sw5='LS=EIEM_Kongepingvin_18.05_DA_S4'
    sw6='LS=EIEM_Kongepingvin_18.05_DA_S5'
    ...
    for filename in glob.glob(os.path.join(log_directory, '*.log')):
        with open(filename, 'r') as f:
            ...
            data5=text.count(sw5)
            data6=text.count(sw6)
